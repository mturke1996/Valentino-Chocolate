  ...
  const statCards = [
    {
      ...
      change: "+12%",
      changeColor: "text-blue-700 bg-blue-100",
    },
    {
      ...
      change: "+8%",
      changeColor: "text-purple-700 bg-purple-100",
    },
    {
      label: "المنتجات",
      ...
      change: "+3",
      changeColor: "text-indigo-700 bg-indigo-100",
    },
    {
      ...
      change: "-2",
      changeColor: "text-yellow-700 bg-yellow-100",
    },
  ];
