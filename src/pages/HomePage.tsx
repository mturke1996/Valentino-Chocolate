...
const demoProducts: Product[] = [
  {
    ...
    descriptionEn: "Rich dark chocolate with 70% cocoa",
    price: 55,
    images: [
  ...
  },
  {
    ...
    descriptionEn: "Premium chocolate filled with natural hazelnut cream",
    price: 60,
    images: [
  ...
  },
  {
    ...
    descriptionEn: "Smooth creamy white chocolate with wonderful taste",
    price: 50,
    images: [
  ...
  },
  {
    ...
    nameEn: "Special Gift Box",
    descriptionAr: "علبة هدايا فاخرة تحتوي على تشكيلة متنوعة من الشوكولاتة",
    descriptionEn: "Luxury gift box with assorted chocolates",
    price: 120,
    images: [
  ...
  },
  {
    ...
    descriptionEn: "Premium chocolate with golden caramel filling",
    price: 65,
    images: [
  ...
  },
  {
    ...
    descriptionEn: "Milk chocolate with natural strawberry pieces",
    price: 58,
    images: [
          ...
          >
            ...
            <div className="space-y-8 mb-16">
              <motion.p
                ...
                style={{ fontFamily: "Cairo, Tajawal, sans-serif" }}
              >
                فالنتينو للشوكولاتة هي وجهتك المثالية للحصول على أجود أنواع الشوكولاتة الفاخرة في ليبيا. 
                نقدم مجموعة متنوعة من الشوكولاتة المستوردة والمحلية بأعلى معايير الجودة.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                style={{ fontFamily: "Cairo, Tajawal, sans-serif" }}
              >
                نسعى دائماً لإسعاد عملائنا بتقديم منتجات استثنائية وخدمة مميزة، ونحرص على أن تكون تجربة التسوق لدينا فريدة ومميزة.
              </motion.p>
            </div>
            ...
            >
              ...
              >
                ...
                <span className="text-lg font-bold group-hover:text-primary-container transition-colors">فيسبوك</span>
              </motion.a>
              ...
              >
                ...
                <span className="text-lg font-bold group-hover:text-primary-container transition-colors">إنستجرام</span>
              </motion.a>
              ...
              >
                ...
                <span className="text-lg font-bold group-hover:text-primary-container transition-colors">واتساب</span>
              </motion.a>
            </motion.div>
          </motion.div>
        </div>
